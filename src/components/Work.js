...
import delta from '../assets/delta_energy.png'
...
{/* Container */}
        <div className='grid sm:grid-cols-2 md:grid-cols-3 gap-4'>
            ...
            {/* Grid Item */}
          <div
            style={{ backgroundImage: `url(${headcount})` }}
          ...
          >
            ...
            <div className='opacity-0 group-hover:opacity-100'>
              ...
              {/* <a href='https://headcount-bt.herokuapp.com/'>
                ...
                <a href='https://github.com/aaronmitchellvt/nextjs-rollcall'>
                  <button className='text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg'>
                    Code
                  </button>
                </a>
          ...
          <div
            style={{ backgroundImage: `url(${delta})` }}
            className='shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center mx-auto content-div'
          >
            <div className='opacity-0 group-hover:opacity-100'>
              <span className='text-2xl font-bold text-white tracking-wider'>
